...
| A comment Update is published under the current ap_id only, never under legacy_ap_id | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Federation.Publisher.build_update_comment/2` | [`publisher_test.exs`](../test/baudrate/federation/publisher_test.exs) |
| A comment Update is gated by the board like a publication, not exempt like a withdrawal | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Federation.Publisher.publish_comment_updated/2` | [`publisher_test.exs`](../test/baudrate/federation/publisher_test.exs) |
| The federated `updated` field is derived from a revision existing, never from updated_at | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Content.Comments.comment_edited?/1`, `Baudrate.Content.Articles.article_edited?/1` | [`object_builder_test.exs`](../test/baudrate/federation/object_builder_test.exs) |
| A described image federates as the attachment name; an undescribed one carries none rather than an empty one | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `Baudrate.Federation.ObjectBuilder.comment_object/1`, `Baudrate.Federation.ObjectBuilder.article_object/1` | [`object_builder_test.exs`](../test/baudrate/federation/object_builder_test.exs) |
...
| The sitemap lists only local, public, non-deleted articles in a guest-viewable board | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `Baudrate.Content.Sitemap.public_article_slugs/2` | [`sitemap_test.exs`](../test/baudrate/content/sitemap_test.exs) |
| An unlisted article is left out of the sitemap and its page carries noindex | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `Baudrate.Content.Sitemap.count_public_articles/0`, `BaudrateWeb.Crawlers.noindex?/1` | [`crawler_surface_test.exs`](../test/baudrate_web/crawler_surface_test.exs) |
| Member profiles are crawlable but never enumerated: no /users/:name is in any sitemap | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `BaudrateWeb.SitemapController.index/2` | [`crawler_surface_test.exs`](../test/baudrate_web/crawler_surface_test.exs) |
...
| Editing a comment writes a revision of the pre-edit body and content warning, every time | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Content.Comments.update_comment/3` | [`comment_revision_test.exs`](../test/baudrate/content/comment_revision_test.exs) |
| The author alone may edit a comment — not an admin, not a board moderator | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Content.Permissions.can_edit_comment?/2` | [`comment_revision_test.exs`](../test/baudrate/content/comment_revision_test.exs) |
| A soft-deleted comment cannot be edited, and its history answers 404 | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Content.Comments.update_comment/3`, `BaudrateWeb.CommentHistoryLive.mount/3` | [`comment_history_live_test.exs`](../test/baudrate_web/live/comment_history_live_test.exs) |
| A comment's edit history is readable by anyone who can read its article, and by nobody else | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `BaudrateWeb.CommentHistoryLive.mount/3` | [`comment_history_live_test.exs`](../test/baudrate_web/live/comment_history_live_test.exs) |
| A local comment body is bounded at 64 KB, like an article's | [0060](adr/0060-an-edit-is-kept-and-the-history-is-public.md) | `Baudrate.Content.Comment.changeset/2` | [`comment_revision_test.exs`](../test/baudrate/content/comment_revision_test.exs) |
| An image description with no text is stored as nil, never "" — `alt=""` claims the image is decorative | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `Baudrate.Content.ImageAlt.validate/1` | [`image_alt_test.exs`](../test/baudrate/content/image_alt_test.exs) |
| A peer's attachment name is kept, stripped of tags and bounded, rather than discarded | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `Baudrate.Content.ImageAlt.from_remote/1` | [`image_alt_test.exs`](../test/baudrate/content/image_alt_test.exs) |
| Only the uploader may describe an image, and another member gets the missing-image answer | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `Baudrate.Content.Images.update_article_image_alt/3` | [`image_alt_test.exs`](../test/baudrate/content/image_alt_test.exs) |
| A draft is read only by its owner, and another member's id answers as a miss rather than a refusal | [0062](adr/0062-a-draft-is-kept-in-two-places-on-purpose.md) | `Baudrate.Content.Drafts.get/2` | [`draft_test.exs`](../test/baudrate/content/draft_test.exs) |
| The draft cap is a COUNT at save time, never a stored counter, and bounds creation only | [0062](adr/0062-a-draft-is-kept-in-two-places-on-purpose.md) | `Baudrate.Content.Drafts.quota_remaining/1` | [`draft_test.exs`](../test/baudrate/content/draft_test.exs) |
| An image a draft is holding is not an orphan, so a post drafted overnight keeps its pictures | [0062](adr/0062-a-draft-is-kept-in-two-places-on-purpose.md) | `Baudrate.Content.Images.delete_orphan_article_images/1` | [`draft_test.exs`](../test/baudrate/content/draft_test.exs) |
| A draft never restores over shared content or into a board composer | [0062](adr/0062-a-draft-is-kept-in-two-places-on-purpose.md) | `BaudrateWeb.ArticleNewLive.mount/3` | [`drafts_live_test.exs`](../test/baudrate_web/live/drafts_live_test.exs) |
...
| A search with no scope is refused, not answered with everything: a date range alone is /recent through the search box | [0055](adr/0055-unanswered-is-a-river-and-tags-is-a-ranking.md) | `Baudrate.Content.SearchQuery.scoped?/1` | [`no_content_ranking_test.exs`](../test/baudrate_web/no_content_ranking_test.exs) |
| Search ranks the reader's own query and never an engagement signal | [0054](adr/0054-attention-follows-the-board-not-a-ranking.md) | `Baudrate.Content.Search.order_for/3` | [`search_test.exs`](../test/baudrate/content/search_test.exs) |
...
| The image-description input carries no name and sits in an ignored container, so a re-render cannot erase it | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `BaudrateWeb.CoreComponents.image_alt_input/1` | [`core_components_test.exs`](../test/baudrate_web/components/core_components_test.exs) |
| A gallery image is announced once: the link carries the description and the img is alt="" | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `BaudrateWeb.Helpers.image_link_label/2` | [`image_alt_test.exs`](../test/baudrate/content/image_alt_test.exs) |
| An img in stored HTML with no description is announced, not skipped: alt="" is filled in at render | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `BaudrateWeb.ImageAltFallback.fill/1`, `BaudrateWeb.SafeHTML.body_html/1` | [`image_alt_fallback_test.exs`](../test/baudrate_web/image_alt_fallback_test.exs) |
| Every image upload surface renders a description field; only an avatar is exempt | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `BaudrateWeb.CoreComponents.image_alt_input/1` | [`image_alt_coverage_test.exs`](../test/baudrate_web/image_alt_coverage_test.exs) |
| Stored content reaches the page through SafeHTML, so the proxy rewrite and the alt fallback both apply | [0061](adr/0061-an-image-description-is-not-a-form-field.md) | `BaudrateWeb.SafeHTML.markdown/1`, `BaudrateWeb.SafeHTML.body_html/1` | [`rendered_html_passes_test.exs`](../test/baudrate_web/rendered_html_passes_test.exs) |
...
| robots.txt blocks machine endpoints only; unwanted pages carry noindex and stay crawlable | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `BaudrateWeb.SitemapController.robots/2` | [`crawler_surface_test.exs`](../test/baudrate_web/crawler_surface_test.exs) |
| A reverse proxy serves from disk only what static_paths/0 lists, so a route is never shadowed | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `BaudrateWeb.static_paths/0` | [`nginx_static_paths_test.exs`](../test/ops/nginx_static_paths_test.exs) |
| A noindex page carries no canonical link, and an indexable one names itself absolutely | [0057](adr/0057-a-sitemap-invites-only-what-a-guest-sees.md) | `BaudrateWeb.Crawlers.canonical_url/2` | [`crawler_surface_test.exs`](../test/baudrate_web/crawler_surface_test.exs) |
| The CSP admits the service worker with worker-src 'self' | [0059](adr/0059-the-service-worker-caches-the-shell-and-never-content.md) | `BaudrateWeb.Router` | [`security_headers_test.exs`](../test/baudrate_web/security_headers_test.exs) |
| /offline renders for a guest, carries noindex and names no canonical | [0059](adr/0059-the-service-worker-caches-the-shell-and-never-content.md) | `BaudrateWeb.PageController.offline/2` | [`page_controller_test.exs`](../test/baudrate_web/controllers/page_controller_test.exs) |
| /offline is never invited into an index | [0059](adr/0059-the-service-worker-caches-the-shell-and-never-content.md) | `BaudrateWeb.Crawlers.noindex_path?/1` | [`crawler_surface_test.exs`](../test/baudrate_web/crawler_surface_test.exs) |
| Registering the worker on every page throws nothing anywhere | [0059](adr/0059-the-service-worker-caches-the-shell-and-never-content.md) | — | [`js_errors_test.exs`](../test/baudrate_web/features/js_errors_test.exs) |
| A reset link is issued only against an admin-verified OpenPGP recovery contact | [0058](adr/0058-account-recovery-is-anchored-outside-the-instance.md) | `Baudrate.Auth.Recovery.issue/4` | [`account_recovery_test.exs`](../test/baudrate/auth/account_recovery_test.exs) |
| Changing a recovery address or key drops the contact back to pending | [0058](adr/0058-account-recovery-is-anchored-outside-the-instance.md) | `Baudrate.Auth.RecoveryContact.changeset/3` | [`account_recovery_test.exs`](../test/baudrate/auth/account_recovery_test.exs) |
| Nobody issues a reset for an account at or above their own role level | [0058](adr/0058-account-recovery-is-anchored-outside-the-instance.md) | `Baudrate.Auth.Recovery.can_issue?/2` | [`account_recovery_test.exs`](../test/baudrate/auth/account_recovery_test.exs) |
| Clearing second factors is a separate choice with its own audit line | [0058](adr/0058-account-recovery-is-anchored-outside-the-instance.md) | `Baudrate.Auth.Recovery.issue/4` | [`account_recovery_test.exs`](../test/baudrate/auth/account_recovery_test.exs) |
| A reset token is single-use, stored hashed, and every failure answers alike | [0058](adr/0058-account-recovery-is-anchored-outside-the-instance.md) | `Baudrate.Auth.Recovery.redeem/3` | [`account_recovery_web_test.exs`](../test/baudrate_web/account_recovery_web_test.exs) |
...
|---|---|---|
| The service worker caches the offline page and fingerprinted assets, and never content | [0059](adr/0059-the-service-worker-caches-the-shell-and-never-content.md) | Whether a new `cache.put` is caching the shell or somebody's reading is a judgement. The shape of `assets/js/service_worker.js` makes it structural — three write sites, one of which re-checks its own prefix — but nothing fails a build when a fourth is added. |
