defmodule BaudrateWeb.Endpoint do
  ...
  # Direct-message images live under uploads/ but are never served by path
  # (ADR 0071); refuse them before Plug.Static can.
  plug BaudrateWeb.Plugs.DenyPrivateUploads
