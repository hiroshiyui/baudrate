defmodule BaudrateWeb.Admin.ModerationLogLive do
  ...
  defp translate_action("reject_user"), do: gettext("Refuse Registration")
  defp translate_action("warn_user"), do: gettext("Warn User")
  defp translate_action("silence_user"), do: gettext("Silence User")
  defp translate_action("suspend_user"), do: gettext("Suspend User")
  defp translate_action("lift_sanction"), do: gettext("Lift Sanction")
  ...
  defp translate_action("create_rule"), do: gettext("Add Site Rule")
  defp translate_action("update_rule"), do: gettext("Edit Site Rule")
  defp translate_action("retire_rule"), do: gettext("Retire Site Rule")
  defp translate_action("restore_rule"), do: gettext("Restore Site Rule")
  defp translate_action("reorder_rules"), do: gettext("Reorder Site Rules")
