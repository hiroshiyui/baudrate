defmodule Baudrate.Federation.TimelineItemBoost do
  @moduledoc """
  Schema for timeline item boosts.

  Tracks local user boosts on remote timeline items. Used to send AP `Announce`
  ...
  schema "timeline_item_boosts" do
    field :ap_id, :string
  ...
  @doc "Changeset for creating a timeline item boost."
