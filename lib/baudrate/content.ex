defmodule Baudrate.Content do
      ...
      true ->
        ...
        result =
          ...
          |> Ecto.Multi.run(:recalc_counts, fn repo, _ ->
            recalc_poll_counts(repo, poll.id)
          end)
          |> Repo.transaction()
  ...
  def recalc_poll_counts(poll_id) do
    recalc_poll_counts(Repo, poll_id)
  end

  defp recalc_poll_counts(repo, poll_id) do
  ...
  defp maybe_insert_poll(multi, nil), do: multi

  defp maybe_insert_poll(multi, poll_attrs) do
