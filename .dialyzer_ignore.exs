...
[
  ...
  {"lib/baudrate/federation/delivery.ex", :pattern_match_cov},
  ...
  {"lib/baudrate/federation/object_resolver.ex", :pattern_match_cov},
  ...
  {"lib/baudrate_web/live/admin/federation_live.ex", :pattern_match_cov},
  ...
  {"lib/baudrate_web/live/conversation_live.ex", :pattern_match_cov},
