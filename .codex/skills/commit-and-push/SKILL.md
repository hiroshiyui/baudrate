...
2. Commit with a clear, concise message following the Conventional Commits standard, for example `feat(bots): add favicon retry logic`. The message should explain why the change was made, not just what changed.
