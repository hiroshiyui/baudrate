...
- **Admin dashboard** -- site settings, registration mode, pending user approval, federation dashboard, moderation queue, held posts, moderation log, invite code management, IP bans, content filters
